...
const Banner = () => {
  ...
  return (
      ...
      <div className='bannerMiniContainer px-36'>
        ...
        <div className='py-5 bg-white w-[25rem] flex space-x-2 justify-around'>
        <p>Daily</p>  
        <p>Rental </p>
        <p>Outstation</p>
        </div> 
        <div className='bg-white pt-5 '>
          <div className='flex items-center justify-around'>
            ...
            <div onClick={() => router.push("/")} className='searchOlaCabButton cursor-pointer flex items-center py-2 px-14 border border-slate-900 justify-around'>
