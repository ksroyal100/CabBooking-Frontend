...
const Footer = () => {
  return (
    <footer className='mt-40 bg-gray-300'>
        ...
        <div className='grid grid-cols-1 md:flex justify-around'>
          ...
          <div className='footer-links'>
            ...
            <ul className='mt-4'>
              ...
              <li>
                <a href="#" className='text-grey-400 hover:text-white'>Book a Ride</a>
              </li>
              <li>
          ...
          <div className='footer-links'>
            ...
            <ul className='mt-4'>
              <li>
                <a href='#' className='text-grey-400 hover:text-white'>Help Center</a>
              </li>
              <li>
                <a href='#' className='text-grey-400 hover:text-white'>Contact Us</a>
              </li>
              <li>
                <a href='#' className='text-grey-400 hover:text-white'>FAQs</a>
              </li>
            </ul>
          </div>
          <div className='footer-links'>
            ...
            <ul className='mt-4'>
              <li>
              <a href='#' className='text-grey-400 hover:text-white'>Terms & Conditions</a>
              </li>
              <li>
              <a href='#' className='text-grey-400 hover:text-white'>Privacy Policy</a>
              </li>
            </ul>
          </div>
